...
data = [
    [(48.128985, 11.575127),(48.133052, 11.583624),datetime.strptime("2017-12-04 18:30","%Y-%m-%d %H:%M"),"Fahrt1"],
    [(48.131620, 11.575985),(48.135745, 11.588345),datetime.strptime("2017-12-04 18:40","%Y-%m-%d %H:%M"),"Fahrt2"],
    [(48.131620, 11.575985),(48.141071, 11.598043),datetime.strptime("2017-12-04 18:50","%Y-%m-%d %H:%M"),"Fahrt3"],
    [(48.128985, 11.575127),(48.139582, 11.606712),datetime.strptime("2017-12-04 18:30","%Y-%m-%d %H:%M"),"Fahrt4"],
    [(48.141071, 11.598043),(48.138150, 11.614695),datetime.strptime("2017-12-04 18:20","%Y-%m-%d %H:%M"),"Fahrt5"],
    [(48.135745, 11.588345),(48.134542, 11.615896),datetime.strptime("2017-12-04 18:10","%Y-%m-%d %H:%M"),"Fahrt6"]
]
